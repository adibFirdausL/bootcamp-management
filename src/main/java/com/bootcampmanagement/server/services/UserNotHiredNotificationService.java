...
@Service
public class UserNotHiredNotificationService {
    ...
    @Autowired
    public UserNotHiredNotificationService(JavaMailSender javaMailSender) {
...
//        SimpleMailMessage smm = new SimpleMailMessage();
        ...
        // Subject
        helper.setSubject("Failed On Interview");
        // Body
        message.setText("<p>Dear " + employee.getName() + ",</p>"
                ...
                + "<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;UNQUALIFIED&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1><br>"
                + "<p>We wish you a Good Result in your next Interview.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><br>"
